...
<div class="container">
    <div class="form-card">
        <form id="ressourceForm" method="post" action="index.php?entity=ressource&action=update&area=admin">
                ...
                <select name="matiere_id" id="matiere_id">
                    ...
                    <?php if (!empty($matieres)) foreach ($matieres as $m): ?>
                        <option value="<?php echo (int)$m['id']; ?>" 
                            <?php echo (isset($ressource['matiere_id']) && (int)$ressource['matiere_id'] === (int)$m['id']) ? 'selected' : ''; ?>>
            ...
            <label>Titre:<br />
                <input type="text" name="titre" id="titre" 
                       value="<?php echo htmlspecialchars($ressource['titre']); ?>" />
            ...
            <label>Type de ressource:<br />
                <input type="text" name="type_ressource" 
                       value="<?php echo htmlspecialchars($ressource['type_ressource']); ?>" />
            </label><br /><br />

            <label>URL:<br />
                <input type="text" name="url" id="url" 
                       value="<?php echo htmlspecialchars($ressource['url']); ?>" 
                       placeholder="https://..." />
            ...
            <label>Auteur:<br />
                <input type="text" name="auteur" 
                       value="<?php echo htmlspecialchars($ressource['auteur']); ?>" />
            </label><br /><br />

            <label>Date d'ajout:<br />
                <input type="text" name="date_ajout" 
                       value="<?php echo htmlspecialchars($ressource['date_ajout']); ?>" readonly />
            </label><br /><br />
