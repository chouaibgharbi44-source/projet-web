    ...
    <div class="main-content">
        ...
        <div class="hero-section">
            <div class="hero-content">
                <h1 class="hero-title">Campus Connect</h1>
        ...
        <div class="modern-post-form">
            ...
            <form action="views/addpost.php" method="POST" id="postForm">
        ...
        <!-- Posts Feed -->
        <h2 style="margin-bottom: 25px; color: var(--dark); font-size: 1.5rem; font-weight: 600;">
            <i class="fas fa-stream" style="margin-right: 10px;"></i>Fil d'actualité
        </h2>
            ...
            ?>
                    <div class="modern-post" id="post-<?= $p['id'] ?>">
                        ...
                        <div class="post-actions">
                            <a href="views/like.php?post_id=<?= $p['id']; ?>" class="btn-action btn-like">
                        ...
                        <!-- Add Comment Form -->
                        <form action="views/addcomment.php" method="POST" class="add-comment-form" data-post-id="<?= $p['id'] ?>">
