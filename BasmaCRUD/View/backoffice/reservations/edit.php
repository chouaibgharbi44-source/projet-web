...
<head>
    ...
    <title>Modifier Réservation - Campus Connect Admin</title>
    <!-- Font Awesome -->
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container-clean">
            <form method="post" action="index.php?entity=reservation&action=update&area=admin"
                ...
                <div class="form-group-cs" style="margin-bottom:20px;">
                    <label for="edit_event_id">Événement Associé</label>
                    <select name="event_id" id="edit_event_id" class="form-input-cs">
                        <?php foreach ($events as $ev): ?>
                            <option value="<?php echo $ev['id']; ?>" <?php echo $ev['id'] == $reservation['event_id'] ? 'selected' : ''; ?>>
                ...
                <div class="form-row-cs">
                    <div class="form-group-cs">
                        ...
                        <input type="text" name="name" id="edit_name" class="form-input-cs"
                            value="<?php echo htmlspecialchars($reservation['name']); ?>" />
                    </div>
                    <div class="form-group-cs">
                        <label for="edit_email">Email</label>
                        <input type="email" name="email" id="edit_email" class="form-input-cs"
                ...
                <div class="form-row-cs">
                    <div class="form-group-cs">
                        <label for="edit_seats">Nombre de places</label>
                        <input type="number" name="seats" id="edit_seats" class="form-input-cs"
                            value="<?php echo htmlspecialchars($reservation['seats']); ?>" />
                    </div>
                    <div class="form-group-cs">
