    ...
    <div class="header">
        <div class="header-inner">
            ...
            <nav class="simple-nav">
                ...
                <a href="index.php" class="nav-item active">Forum</a>
                <a href="../VV13/index.php" class="nav-item">Ressources</a>
                <a href="../BasmaCRUD/index.php" class="nav-item">Événements</a>
                ...
                <a href="../view/FrontOffice/profile.php" class="nav-item">Profil</a>
